...
const EN = {
  ...
  "prodotti.detail.designer.label": "Designer",
  "prodotti.detail.designer.cta": "View profile →",
  "prodotti.detail.docs.unavailable": "Documentation not yet available.",
  "prodotti.detail.discover_more": "Discover more →",
  "prodotti.detail.projects.label": "Projects",
  "prodotti.detail.projects.title": "Spaces dressed in elegance with {name}",
  "prodotti.detail.projects.cta": "Explore the projects →",
  "prodotti.detail.support.label": "Support for professionals",
  "prodotti.detail.support.title": "Do you have a contract project\nto develop?",
  "prodotti.detail.support.description": "Collaborate with our team to develop unique projects that meet your client's needs.",
  "prodotti.detail.support.feature1": "Custom product dimensions",
