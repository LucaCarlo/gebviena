...
const PREVIEW_URL = "/area-professionisti/cataloghi";
  ...
  return (
    <div>
      <div className="flex items-start justify-between gap-4 flex-wrap mb-4">
        <div>
          <h1 className="text-2xl font-semibold text-warm-800">Modifica Catalogo</h1>
          {isActive !== null && (
        ...
        <a href={PREVIEW_URL} target="_blank" rel="noopener noreferrer"
          ...
          <ExternalLink size={14} /> Apri pagina cataloghi
        </a>
      </div>
      ...
      <div style={{ display: tab === "preview" ? "block" : "none" }}>
        <div className="border border-warm-200 rounded-lg overflow-hidden bg-warm-100 flex justify-center"
          ...
          <iframe key={refreshKey} src={`${PREVIEW_URL}?_t=${refreshKey}`} title="Anteprima cataloghi"
