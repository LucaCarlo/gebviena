      ...
      <div className="max-w-5xl mx-auto px-6 lg:px-8">
        ...
        <div className="bg-white border border-warm-200 px-8 py-16 text-center">
          ...
          <p className="text-warm-700 leading-relaxed max-w-md mx-auto">
            {t("placeholder.digital_media.body")}{" "}
            {t("placeholder.digital_media.contact")}{" "}
            <a href="mailto:info@gebruederthonetvienna.com" className="underline hover:text-warm-900">info@gebruederthonetvienna.com</a>.
          </p>
        </div>
      </div>
    </main>
