...
import CataloghiClient from "../cataloghi/CataloghiClient";

export const dynamic = "force-dynamic";
const SLUG = "listino-prezzi";
// Section usata dal tab admin "Listini prezzi" quando carica i PDF (plurale).
// NB: SLUG (URL) e' singolare, la section del DB e' plurale (storicamente).
const CATALOG_SECTION = "listini-prezzi";
  ...
  return (
    <main className="min-h-screen bg-warm-50 pt-32 pb-24">
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <CataloghiClient
          lang={lang}
          sectionFilter={CATALOG_SECTION}
          i18n={{
            loading: t("catalogs.loading"),
            empty: t("catalogs.empty"),
            previewUnavailable: t("catalogs.preview_unavailable"),
            pdfUnavailable: t("catalogs.pdf_unavailable"),
            downloadPdf: t("catalogs.download_pdf"),
            allLabel: t("catalogs.all"),
          }}
        />
      </div>
    </main>
