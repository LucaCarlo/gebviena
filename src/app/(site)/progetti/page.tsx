...
function ProjectsHero() {
  ...
  if (loaded && slides.length === 0) {
    return (
      <section className="relative w-full flex items-center justify-center bg-warm-900 h-[calc(100vh-7.5rem-48px-150px)] max-md:h-[55vh]">
        <motion.h1
  ...
  return (
    <section className="relative w-full overflow-hidden h-[calc(100vh-7.5rem-48px-150px)] max-md:h-[55vh]">
