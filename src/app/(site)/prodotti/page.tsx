...
function ProductsHero() {
  ...
  if (loaded && slides.length === 0) {
    return (
      <section className="relative w-full flex items-center justify-center bg-warm-900 h-[min(calc(113vh-170px),887px)] max-md:h-[55vh]">
        <motion.h1
  ...
  if (!loaded) {
    return (
      <section className="relative w-full flex items-center justify-center bg-warm-100 h-[min(calc(113vh-170px),887px)] max-md:h-[55vh]">
  ...
  return (
    <section className="relative w-full overflow-hidden h-[min(calc(113vh-170px),887px)] max-md:h-[55vh]">
