...
export async function POST(req: Request) {
  ...
  try {
    ...
    const landingPageUrl = `${siteUrl}/contatti/landing-page`;
      ...
      const html = `
        <div style="font-family: Georgia, 'Times New Roman', serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="padding: 30px 40px; text-align: center;">
            <a href="${landingPageUrl}" style="display: inline-block; background-color: #3a5a6a; color: #ffffff; text-decoration: none; padding: 14px 40px; font-size: 16px; border-radius: 6px; font-family: Georgia, serif;">
