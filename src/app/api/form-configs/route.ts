...
const DEFAULTS: Record<string, { key: string; label: string; type: string; required: boolean; enabled: boolean; order: number }[]> = {
  ...
  collaboration: [
    ...
    { key: "phone", label: "Telefono", type: "tel", required: false, enabled: false, order: 5 },
    { key: "contactReason", label: "Motivo del contatto", type: "select", required: false, enabled: false, order: 6 },
    { key: "subject", label: "Oggetto", type: "text", required: false, enabled: false, order: 7 },
    { key: "message", label: "Messaggio", type: "textarea", required: false, enabled: false, order: 8 },
    { key: "notes", label: "Altre informazioni", type: "textarea", required: false, enabled: true, order: 9 },
    { key: "acceptPrivacy", label: "Conferma di aver preso visione dell'informativa della Privacy e sull'utilizzo dei dati personali", type: "checkbox", required: true, enabled: true, order: 10 },
    { key: "acceptProfiling", label: "Presto il consenso per le attività di profilazione", type: "checkbox", required: true, enabled: true, order: 11 },
    { key: "subscribeNewsletter", label: "Desidero ricevere aggiornamenti e novità", type: "checkbox", required: false, enabled: false, order: 12 },
  ],
};
