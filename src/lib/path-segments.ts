...
export const SEGMENT_TRANSLATIONS: SegmentMap = {
  en: {
    ...
    "news-e-rassegna-stampa": "news-and-press",
  ...
  de: {
    ...
    "news-e-rassegna-stampa": "news-und-presse",
    "mondo-gtv": "gtv-welt",
  ...
  fr: {
    ...
    "news-e-rassegna-stampa": "actualites-et-presse",
    "mondo-gtv": "monde-gtv",
  ...
  es: {
    ...
    "news-e-rassegna-stampa": "noticias-y-prensa",
    "mondo-gtv": "mundo-gtv",
    "brand-manifesto": "manifiesto-de-marca",
    heritage: "herencia",
    "curvatura-legno": "la-curvatura-de-la-madera",
    sostenibilita: "sostenibilidad",
    "designer-e-premi": "disenadores-y-premios",
    "gtv-experience": "experiencia-gtv",
