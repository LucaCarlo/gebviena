...
const D: Record<string, Dict> = {
  ...
  "bacheca.title": { it: "Bacheca", fr: "Tableau d'affichage", en: "Notice board", de: "Pinnwand", es: "Tablón" },
  "bacheca.subtitle": {
    it: "Aggiornamenti e novità per i professionisti: nuovi cataloghi, listino prezzi aggiornato, media, modifiche alle credenziali.",
    fr: "Mises à jour et nouveautés pour les professionnels : nouveaux catalogues, liste de prix mise à jour, médias, modifications des identifiants.",
    en: "Updates and news for professionals: new catalogues, updated price list, media, credential changes.",
    de: "Aktualisierungen und Neuigkeiten für Fachleute: neue Kataloge, aktualisierte Preisliste, Medien, Änderungen der Zugangsdaten.",
    es: "Actualizaciones y novedades para los profesionales: nuevos catálogos, lista de precios actualizada, medios, cambios en las credenciales.",
  },
  ...
  "pro.field.company_agency": {
    it: "Nome agenzia", fr: "Nom de l’agence",
    en: "Agency name", de: "Agenturname", es: "Nombre de la agencia",
  },
